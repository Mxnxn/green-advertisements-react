...
const AddInvoice = ({isVisible,close,state,submit,clients,setState,name}) => {
    return isVisible  && ( <div className={isVisible ? "modal d-block " : "modal"}>
    <div className="modal-dialog" role="document">
        <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                {!state.success && <div class="form-group">
                    <span>Client</span>
                    <select
            ...
            <div class="modal-footer">
               {!state.success && <button type="button" class="btn btn-primary" onClick={submit}>
                    Assign
                </button>}
